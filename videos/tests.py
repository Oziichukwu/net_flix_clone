...
class VideoModeTestCase(TestCase):
    def setUp(self):
        self.obj_a = Video.objects.create(title = 'This is a title', video_id = 'regs')
        self.obj_b = Video.objects.create(title = 'This is title' , state=Video.VideoStateOptions.PUBLISH,
        video_id = 'kjsjss')
